  ...
  <div class="sticky-container">
    <ul class="sticky">
        <li>
            ...
            <p><a href="# target="_blank"> <img src="img/facebook.png" width="32" height="32"></a></p>
        </li>
        <li>
            
            <p><a href="#" target="_blank"><img src="img/twitter.png" width="32" height="32"></a></p>
        </li>
        <li>
           
            <p><a href="#" target="_blank"> <img src="img/Instagram.png" width="32" height="32"></a></p>
        </li>
...
<div id="encdiv"></div>
  ...
  <section id="mejoremos" class="padd-section text-center wow fadeInUp" >
	 <section id="services" class="services section-bg">
        ...
        <h3 class="modal-title">Webinar Neque porro quisquam est qui dolorem ipsum</h3>
          ...
          <span aria-hidden="true">&times;</span>
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <a href="pdf/W01-Planes-Integrales-Movilidad.pdf" target="_blank" class="letrasoff2"><p>Phasellus et mattis arcu 1</p></a>
                </div>
                 <div class="col-6">
                     <a href="#" target="_blank"><img src="img/iconfinder_file-pdf_285666.png" width="20%"></a>
                  <a href="pdf/Webinar 1 Pimus Los Cabos.pdf" target="_blank" class="letrasoff2"><p>Phasellus et mattis arcu 2</p></a>
                 </div>
              </div>
                ...
                Etiam mollis odio id diam dictum, quis gravida massa tristique. Maecenas laoreet congue leo et auctor. Etiam bibendum urna non ex efficitur, et varius nulla rhoncus
                 <br>
                  <strong style="font-weight: bold">WEBINAR</strong>
                      ...
                      <!-- Modal4 -->
<div id="myModal2"  class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" >
 <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
        <h3 class="modal-title"> Etiam mollis odio id diam dictum, quis gravida massa tristique</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
              ...
              <div class="row">
                <div class="col-6">
                  <a href="#" target="_blank"><img src="img/iconfinder_file-pdf_285666.png" width="20%"></a>
                  <a href="#" target="_blank" class="letrasoff2"><p> Etiam mollis odio id diam dictum, quis gravida massa tristique 2</p></a>
                </div>
                 <div class="col-6">
                     <a href="#" target="_blank"><img src="img/iconfinder_file-pdf_285666.png" width="20%"></a>
                  <a href="#" target="_blank" class="letrasoff2"><p>Webinar  Etiam mollis odio id diam dictum, quis gravida massa tristique</p></a>
                 </div>
              </div>
              <div class="modal-footer">
...
<!-- Modal4 -->
  ...
  <!--//////-->
  <!--NOTICIAS-->
    <section class="noticias has-padding alternate-bg" id="noticias">
       <div class="container">
                       <br><br>
...
-->
 ...
 <section id="contactanos" class="padd-section text-center wow fadeInUp" >
      ...
      <h2>Para obtener más información sobre el PPDU, contactar a través del correo electrónico</h2>
      <p>
       <div class="row">
        <br><br><br><br>
      <div class="col-md-8">
...
<br><br><br>
  ...
  <footer class="footer">
    ...
    <div class="container">
    <p>&copy; Copyrights FONATUR Ixtapa. todos los derchos resevados.</p>
    <div class="credits">
